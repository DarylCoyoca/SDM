...
$result = mysqli_query($con, "SELECT * FROM `return` ORDER BY id DESC"); 
?>
...
<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for book title.." title="Type in a title">
<table id="customers">
  <tr>
		<th>Title</th>
		<th>Author</th>
