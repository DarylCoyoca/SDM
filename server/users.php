...
$result = mysqli_query($con, "SELECT * FROM `login` ORDER BY id DESC"); 
?>
...
<table id="customers">
	...
	while($res = mysqli_fetch_array($result)) { 		
		...
		echo "<td>".$res['idNum']."</td>";	
		echo "<td>".$res['course']."</td>";
		echo "<td>".$res['year_level']."</td>";	
		echo "<td>".$res['date']."</td>";
		echo "<td>".$res['time']."</td>";
		echo "<td><a href=\"delete_user.php?id=$res[id]\" onClick=\"return confirm('Are you sure you want to delete this User Info?')\">Delete</a></td>";
	}
	?>
</table>
<script>
